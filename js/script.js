...
jQuery(function ($) {
   ...
   ====================================== */
    ...
    $("#team-slider").owlCarousel({
      ...
      $("#team-slider-carreras").owlCarousel({
        items: 2,
        dots: false,
        nav: false,
        responsive: {
